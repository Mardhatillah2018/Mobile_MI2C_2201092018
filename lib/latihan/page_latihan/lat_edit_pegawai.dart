...
import '../model_latihan/model_pegawai_latihan.dart'; // Sesuaikan dengan lokasi model pegawai Anda

class LatihanEditPegawai extends StatefulWidget {
  final Datum data;

  const LatihanEditPegawai({Key? key, required this.data}) : super(key: key);

  @override
  State<LatihanEditPegawai> createState() => _LatihanEditPegawaiState();
}

class _LatihanEditPegawaiState extends State<LatihanEditPegawai> {
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse(
                            'http://192.168.208.154/edukasi_server/updatePegawai.php'),
                        body: {
                            ...
                            showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  title: Text("Gagal"),
                                  content: Text(
                                      "Terjadi kesalahan: ${jsonResponse['message']}"),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
